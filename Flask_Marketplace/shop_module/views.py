...
marketplace.add_app_template_global(can_edit_product)
marketplace.add_app_template_global(currency_options)
marketplace.add_app_template_global(latest_stores)


@marketplace.before_request
def before_request():
...
@ marketplace.route('/cart', methods=['GET'])
@ login_required
def cart():
...
@ marketplace.route('/checkout', methods=['GET'])
@ login_required
def checkout():
    iso_code = request.cookies.get('iso_code')
...
@ marketplace.route('/dashboard', methods=['GET'])
@ login_required
def dashboard():
...
@ marketplace.route('/img/<string:model>/<int:id>', methods=['GET'])
def image(model, id):
    if model == 'product':
...
@ marketplace.route('/market', methods=['GET'])
def market():
    iso_code = request.cookies.get('iso_code')
...
@ marketplace.route('/save-cart', methods=['POST'])
@ login_required
def save_cart():
...
@ marketplace.route('/store/<string:store_name>/admin', methods=['GET', 'POST'])
@ login_required
...
@ marketplace.route('/store/new', methods=['GET', 'POST'])
@ login_required
def store_new():
...
@ marketplace.route('/store/<string:store_name>/products', methods=['GET', 'POST'])
